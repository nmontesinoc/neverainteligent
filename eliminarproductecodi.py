...
teclejat a Telegram, per tal d'eliminar un nombre determinat
...
def handle(msg):
    ...
    if b == 0:
        ...
        # ENVIEM UN MISSATGE A L'USUARI PER A QUE ENS DIGUI QUANTES UNITATS VOL ELIMINAR-NE.
        bot.sendMessage(chat_id, "Digui'ns quantes unitats vol eliminar de " + str(nomproducte[0][0]) +".")
    ...
    # QUAN b =! 0 i c == 0 (ÉS A DIR, UNA SOLA VEGADA), S'EXECUTARÀ AQUEST CODI.
        ...
        global c
        c = 1
        # SI NO HI HA CAP ARTICLE D'AQUEST PRODUCTE, ENVIARÀ UN MISSATGE A L'USUARI INFORMANT-HO.
        ...
        # SI HI HA AL MENYS UNA UNITAT D'AQUEST PRODUCTE, FARÀ L'ACCIÓ DESITJADA.
        if float(quantitat[0][0]) > 0:
            # ACTUALITZEM LA BASE DE DADES, RESTANT LA QUANTITAT SOL·LICITADA AL PRODUCTE.
